...
export function ContextWrapper(props: any) {
  ...
  const [smallCalendarYear, setSmallCalendarYear] = useState<number | null>(
    null
  );
...
export const GlobalContext = React.createContext({
  ...
  smallCalendarMonth: new Date().getMonth() as number | null,
  setSmallCalendarMonth: (index: any) => {},
  year: new Date().getFullYear(),
  setYear: (year: any) => {},
  smallCalendarYear: new Date().getFullYear() as number | null,
  setSmallCalendarYear: (year: any) => {},
